    ...
    <ExerciseLayout>
      ...
      <div className="prose prose-invert max-w-none">
        <div className="font-inter text-base sm:text-lg font-light leading-relaxed space-y-6 opacity-90">
            ...
            probouzí hněv. A to je v pořádku. Dovolte si cítit hněv. Jaký primární pocit však 
            ve vás daná situace vyvolává? Zkuste zachytit, jaký pocit se objevuje ve vašem těle 
            ještě předtím, než vzplane hněv.
            </p>
            
            <p>
            Pokud jste našli tělesný pocit, který právě teď přitahuje vaši pozornost, zkuste 
            najít slovo, které by váš pocit co nejlépe vystihlo. Můžete si položit například 
            následující otázky: Je to leknutí? Šok? Zděšení? Strach? Nebo pocit křivdy, nespravedlnosti? 
            Cítíte se opuštění, zrazení, znevážení či ponížení? Vyvstává ve vás pocit selhání nebo 
            pocit nedostatečnosti? Zeptejte se sami sebe: Jaký pocit předchází můj hněv? Jaký pocit 
